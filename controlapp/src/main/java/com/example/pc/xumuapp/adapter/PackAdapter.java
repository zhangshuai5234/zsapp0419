...
public class PackAdapter extends BaseAdapter {
    ...
    private List<PackModel.DataBean> list;
    LayoutInflater layoutInflater;
    private Context mcontext;

    public PackAdapter(Context context, List<PackModel.DataBean> list){
        this.list = list;
        mcontext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder = new PackAdapter.ViewHolder();
            ...
            viewHolder = (PackAdapter.ViewHolder) convertView.getTag();
        }
