...
public class PlantAdapter extends BaseAdapter {
    ...
    private List<PlantModel.DataBean> list;
    LayoutInflater layoutInflater;
    private Context mcontext;

    public PlantAdapter(Context context, List<PlantModel.DataBean> list){
        this.list = list;
        mcontext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder = new PlantAdapter.ViewHolder();
            ...
            viewHolder = (PlantAdapter.ViewHolder) convertView.getTag();
        }
