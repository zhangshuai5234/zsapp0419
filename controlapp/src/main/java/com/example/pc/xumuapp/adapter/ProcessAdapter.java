...
public class ProcessAdapter extends BaseAdapter {
    ...
    private List<ProcessModel.DataBean> list;
    LayoutInflater layoutInflater;
    private Context mcontext;

    public ProcessAdapter(Context context, List<ProcessModel.DataBean> list){
        this.list = list;
        mcontext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder = (ProcessAdapter.ViewHolder) convertView.getTag();
        }
